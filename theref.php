...
<html>
    ...
    <body>
        <div align="center"><h1>The Ref Reseraunt</h1>
            <?php session_start(); 
...
echo '<table border = 5 bordercolor = red align = center>
    ...
    <tr>
        <td colspan = 4><img src="img\seafood.webp"  width="150" alt="" border=3><br>
        Seafood Tangine</td>
    ...
    <tr>
        <td colspan = 4><img src="img\shrimp.webp"  width="150" alt="" border=3><br>
        Orange-Sesame Noodles with Grilled Shrimp</td>
        <td colspan = 4>$50.00</td>
        <td colspan = 3><textarea name="" id="" cols="30" rows="10"></textarea></td>
        <td colspan = 1><form onsubmit="myOrder();">
            <input type="number" name="quantity" min="1" max="5">
            <input type="submit" value="Order">
    ...
    <tr>
        <td colspan = 4><img src="img\tuna.webp" height="130" width="150" alt="" border=3><br>
        Sesame-crusted Tuna with Teriyaki Stir-Fry</td>
    ...
    <tr>
        <td colspan = 4><img src="img\red.png"  width="150" alt="" border=3><br>
        Pinot Noir</td>
